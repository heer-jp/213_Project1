...
public class CollMan {
    ...
    /**
     * Continuously reads all user input and sends it to commandRunner method.
    ...
    public void run() {
        ...
        while (scanner.hasNextLine()) {
            commandRunner(collection, scanner.nextLine());
        }
    }
    
    /**
     * Reads user input sent from run method and performs appropriate methods.
     * If the user command is valid the specified commands are performed and printed. 
     * Invalid commands are returned with a print statement. 
     * @param collection object that correlates with the array holding album objects.
     * @param command string command line given by user.
     */
    private void commandRunner(Collection collection, String command) {
