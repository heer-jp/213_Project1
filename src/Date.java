...
/**
 * Checks if album object dates are valid.
 * Dates are declared invalid if they do not follow the mm/dd/yyyy format, are a false leap year,
 * go beyond today's date, and or have invalid months, days, or years.
...
public class Date implements Comparable<Date> {
    ...
    public boolean isValid() {
        ...
        if (albumDate.after(currentDate) || year < THE_EIGHTYS)
            return false;
    ...
    /**
     * String formed by combining month, day, and year into date formate. 
     */
    @Override
    ...
    public static void main(String[] args) {
        ...
        Date testCase1a = new Date("31/1/2000");
        ...
        Date testCase1b = new Date("12/1/2000");
        ...
        Date testCase2a = new Date("13/1/2000");
        ...
        Date testCase2b = new Date("12/1/2000");
        ...
        Date testCase3b = new Date("2/29/2020");
        ...
        // Test Case #4 - checking a date before 1980
        System.out.println("Running Test Case #4a:");
        Date testCase4a = new Date("12/31/1979");
        if (!testCase4a.isValid()) {
            System.out.println("Test Case #4a, checking a date before 1980. Passed");
        } else {
            System.out.println("Test Case #4a, checking a date before 1980. Failed");
        }
        
        System.out.println("Running Test Case #4b:");
        Date testCase4b = new Date("1/1/1980");
        if (testCase4b.isValid()) {
            System.out.println("Test Case #4b, checking a date after 1980. Passed");
        } else {
            System.out.println("Test Case #4b, checking a date after 1980. Failed");
        }
        
        // Test Case #5 - checking a future date
        System.out.println("Running Test Case #5a:");
        Date testCase5a = new Date("1/1/2022");
        if (!testCase5a.isValid()) {
            System.out.println("Test Case #5a, checking a future date. Passed");
        } else {
            System.out.println("Test Case #5a, checking a future date. Failed");
        }
        
        System.out.println("Running Test Case #5b:");
        Date testCase5b = new Date("1/1/2021");
        if (testCase5b.isValid()) {
            System.out.println("Test Case #5b, checking a past date (after 1980). Passed");
        } else {
            System.out.println("Test Case #5b, checking a past date (after 1980). Failed");
        }
